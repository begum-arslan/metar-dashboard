...
export default function VisHeadTailWindTab({ data, reportInfo }) {
  const chartRef = useRef(null);
  // Visibility Filter
  const [visThresholdInput, setVisThresholdInput] = useState('');
        ...
        <div className="glass-container" style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px', marginTop: '8px' }}>
            <button 
              ...
              onClick={() => exportGraphAsPNG(chartRef, 'VisHeadTailWindTab.png')}
            >
              📈 Export Graph
            </button>
            <button 
